...
/**
 * AgentHeartbeat — 60-minute agent pulse visualization
 * Shows the last 60 minutes of agent heartbeat status as a horizontal bar.
 * Color coding: green (< 200ms), yellow (200-500ms), red (failed), gray (no data)
 */
export default function AgentHeartbeat({ logs, currentStatus }) {
    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className={`p-2 rounded-lg ${currentStatus === 'ACTIVE' ? 'bg-blue-50' : 'bg-slate-100'}`}>
